        ...
        <div className="max-w-4xl mx-auto p-6 sm:p-8">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">Manage your registered cars</p>
                </div>
                <button
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mt-4 pt-4 border-t border-gray-100">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1.5 text-sm text-red-600 hover:text-red-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                >
