        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-20">
                <div className="px-4 h-14 flex items-center gap-3">
                    ...
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 text-xs font-semibold rounded uppercase tracking-wide shrink-0">
                        Admin
                    </span>
            ...
            {sidebarOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <NavMenu role="ADMIN" orientation="vertical" />
                    </nav>
                </div>
            )}
